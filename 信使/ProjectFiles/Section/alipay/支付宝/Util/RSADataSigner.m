...
- (NSString *)signString:(NSString *)string {
	...
	BOOL flag = [formatKey writeToFile:path atomically:YES encoding:NSUTF8StringEncoding error:nil];
    if (flag) {
        
        path = [[NSBundle mainBundle] pathForResource:@"rsa_private_key" ofType:@"pkcs8"];
