...
// 负责人：李启波（marcyli）
//============================================================
- ( NSMutableDictionary *)sendPayWithProductDic:(NSDictionary *)productDic
{
    //================================
    //预付单参数订单设置
    //================================
    ...
    [packageParams setObject: [productDic objectForKey:@"ordername"]        forKey:@"body"];        //订单描述，展示给用户
    [packageParams setObject: [productDic objectForKey:@"notify_url"]        forKey:@"notify_url"];  //支付结果异步通知
    [packageParams setObject: [productDic objectForKey:@"orderno"]           forKey:@"out_trade_no"];//商户订单号
    [packageParams setObject: @"196.168.1.1"    forKey:@"spbill_create_ip"];//发器支付的机器ip
    [packageParams setObject: [productDic objectForKey:@"orderprice"]       forKey:@"total_fee"];       //订单金额，单位为分
